export const Messages = {
    ...
    DELETE_SUCCESS:"Details have been deleted successfully!",
    FETCH_SUCCESS:"Details have been fetched successfully!",
    LOGGED_IN_SUCCESSFULLY: "Logged in successfully",
    UPDATE_SUCCESS:"Details have been updated successfully!",
    USER_CREATED_SUCCESSFULLY: "User created successfully",

    //ERROR MESSAGES
    CREATE_FAILED:"Failed to create details!",
    DELETE_FAILED:"Failed to delete details!",
    FETCH_FAILED:"Failed to retrieve details!",
    INVALID_EMAIL_OR_PASSWORD: "Invalid Email or Password",
    INTERNAL_SERVER_ERROR: "Internal Server Error",
    INVALID_ID: "inavlidId",
    NO_DETAILS: "No details exist!",
    UPDATE_FAILED:"Failed to update details!",
